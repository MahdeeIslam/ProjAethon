...
export const portfolioItems: LegacyPortfolioItem[] = [
  {
    ...
    media: [
      { type: 'video', url: YT.portfolioLegacy.portfolio1 },
  ...
  },
  {
    ...
    media: [
      { type: 'video', url: YT.portfolioLegacy.portfolio2 },
  ...
  },
  {
    ...
    media: [
      ...
      { type: 'image', url: getHorizontalPhoto(0) },
      { type: 'video', url: YT.portfolioLegacy.portfolio3 },
    ],
  },
  {
    id: '4',
    ...
    media: [{ type: 'video', url: YT.portfolioLegacy.portfolio4 }],
  },
  {
    id: '5',
    ...
    thumbnail: getHorizontalPhoto(0),
    media: [
      { type: 'video', url: YT.portfolioLegacy.portfolio5 },
      { type: 'image', url: getHorizontalPhoto(1) },
    ],
  },
  {
    ...
    media: [
      { type: 'image', url: getHorizontalPhoto(2) },
      { type: 'video', url: YT.portfolioLegacy.portfolio6 },
    ],
  },
  {
    id: '7',
    ...
    thumbnail: getHorizontalPhoto(2),
    media: [
      { type: 'video', url: YT.portfolioLegacy.portfolio7 },
      { type: 'image', url: getHorizontalPhoto(3) },
    ],
  },
]
