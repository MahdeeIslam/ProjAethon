...
const HERO_VIDEO_SRC = '/placeholders/reels/Vertical/backgroun.MP4'
const HERO_VIDEO_FALLBACK = '/placeholders/background.mp4'
const HERO_VIDEO_FALLBACK2 = '/placeholders/hero-loop.mp4'
