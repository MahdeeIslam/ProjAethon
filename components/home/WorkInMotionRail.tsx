...
const FALLBACK_HORIZONTAL = [
  '/placeholders/reels/Horizontal/Copy of Elders promo uncaptioned.mp4',
  '/placeholders/reels/Horizontal/Copy of Third Space Teaser 1.mp4',
  '/placeholders/reels/Horizontal/Copy of UMMA promo uncaptioned.mp4',
  '/placeholders/reels/Horizontal/Copy of moe.vis client work.mp4',
  '/placeholders/reels/Horizontal/Copy of recap elder event ver 5.mp4',
]
