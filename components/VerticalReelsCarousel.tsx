...
const FALLBACK_REEL_PATHS = [
  '/placeholders/reels/Vertical/Musibah.mp4',
  '/placeholders/reels/Vertical/TAOFIQ STORY V2.mp4',
  '/placeholders/reels/Vertical/MVM DR Mustafa V2.mp4',
  '/placeholders/reels/Vertical/MVM GAZA UPDATEDv3.mp4',
  '/placeholders/reels/Vertical/Ree#1 03.MP4',
  '/placeholders/reels/Vertical/Reel#3 02.MP4',
]
